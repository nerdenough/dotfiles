...
" duotone-dark-sea-syntax scheme by simurai (converted via duotone-base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-duotone-dark-sea-syntax.sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-duotone-dark-sea-syntax"
